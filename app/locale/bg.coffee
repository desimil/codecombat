module.exports = nativeDescription: "български език", englishDescription: "Bulgarian", translation:
  ...
  new_home:
#    title: "CodeCombat - Игри за програмиране за изучаване на Python и JavaScript"
...
#    built_for_teachers_subtitle1: "Компютърни науки"
#    built_for_teachers_subblurb1: "Стартирайки този безплатен курс за запознаване с компютърни науки, учениците ще овладяват основни концепции за кодиране като докато/за цикли, функции и алгоритми."
#    built_for_teachers_subtitle2: "Разработване на игри"
#    built_for_teachers_subblurb2: "Учениците конструират свои лабиринти, използват основни кодове за управление, за да създават свои собствени игри, които да споделят с приятели и семейството си ."
#    built_for_teachers_subtitle3: "Web разработки"
#    built_for_teachers_subblurb3: "Използвайки HTML, CSS, and jQuery, учениците програмират свои интернет страници, които могат да споделят със съучениците си."
#    century_skills_title: "Умения на 21 век"
#    century_skills_blurb1: "Учениците не прост развиват своя герой , те развиват и самите себе си.
#    century_skills_quote1: "Обърка… така че, помисли за всички възможни начини да успееш, а след това опитай отново. Нямаше да стигна дотук, ако не бях пробвал пак и пак."
#    century_skills_subtitle1: "Критическо мислене"
#    century_skills_subblurb1: "С пъзелите за програмиране, които постепенно се усложняват с всяко следващо ниво, е сигурно, че се развива и критическото мислене."
#    century_skills_quote2: "Всеки прави свои лабиринти, така че си казах, "Действай!". И го направих!"
#    century_skills_subtitle2: "Креативност"
#    century_skills_subblurb2: "CodeCombat насърчава учениците да проявяват своята креативност като създават и споделят свои собствени игри."
#    century_skills_quote3: "Ако имам затруднения с ниво. Имам възможност да споделям затрудненията си с други участници, за да преодолеем трудностите заедно."
#    century_skills_subtitle3: "Сътрудничество"
#    century_skills_subblurb3: "По време на играта има възможности учениците да си сътрудничат и да работят заедно, използвайки нашето ръководство за програмиране на двойки."
#    century_skills_quote4: "Стремя се да проектирам видео игри и да се науча как да кодирам ... това ми дава чудесна отправна точка."
#    century_skills_subtitle4: "Общуване"
#    century_skills_subblurb4: "Програмирането изисква децата да практикуват нови форми на комуникация, включително да комуникират със самия компютър и да предават своите идеи, използвайки най-ефективния код."
#    classroom_in_box_title: "Ние се стремим:"
#    classroom_in_box_blurb1: "Да ангажираме всеки ученик и да му дадем усещането, че програмирането е и за него."
#    classroom_in_box_blurb2: "Да даваме на възможност всеки учител да бъде уверен, когато обучава в програмиране."
#    classroom_in_box_blurb3: "Да вдъхновяваме всички училищни ръководители да създадат програма за компютърни науки от световна класа."
#    creativity_rigor_title: "Когато се срещнат креатовност и взискателност"
#    creativity_rigor_subtitle1: "Прави програмирането забавно и свързано с реални житейски умения."
#    creativity_rigor_blurb1: "Учениците пишат истински Python и JavaScript докато играят игри насърчавайки работа чрез проба-грешка, критическо мислене, и креативност. След това те прилагат уменията за програмиране, които са научили, като разработват свои собствени игри и уебсайтове в курсове, базирани на проекти."
#    creativity_rigor_subtitle2: "Учениците достигат тяхното ниво"
#    creativity_rigor_blurb2: "Всяко CodeCombat ниво е основано на базата на милиони точки от данни и е оптимизирано да се адаптира към всеки обучаем. Съветите помагат на учениците, когато те заседнат, а нивата на предизвикателства оценяват ученето на учениците през цялата игра."
#    creativity_rigor_subtitle3: "CodeCombat е създаден за всички учители, независимо от опита"
#    creativity_rigor_blurb3: "Самостоятелната, съобразена със стандартите учебна програма на CodeCombat прави преподаването на компютърни науки възможно за всички. CodeCombat снабдява учителите с обучението, инструктивни ресурси и всеотдайната подкрепа, за да се чувстват уверени и успешни в класната стая."
#    featured_partners_title1: "Препоръки в"
#    featured_partners_title2: "Награди & Партньори"
...
#    teachers_love_codecombat_title: "Учителите обичат CodeCombat"
#    teachers_love_codecombat_blurb1: "Споделят, че техните ученици използват с удоволствие CodeCombat, за да се учат да програмират."
...
#    request_quote: "Request a Quote"
    ...
    goto_classes: "Класовете ми"
    view_profile: "Моят профил"
...
#    my_classrooms: "Моите класове"
#    my_courses: "Моите курсове"
#    my_teachers: "Моите учители"
    careers: "Кариери"
#    facebook: "Facebook"
#    twitter: "Twitter"
...
#    schools: "Училища"
#    get_involved: "Включи се"
#    open_source: "Open source (GitHub)"
#    support: "Поддръжка"
#    faqs: "FAQs"
#    copyright_prefix: "Copyright"
#    copyright_suffix: "Всички права са запазени."
#    help_pref: "Нуждаеш се от помощ? Пиши ни"
#    help_suff: "и ние ще се свържем с теб!"
#    resource_hub: "Resource Hub"
#    apcsp: "AP CS Principles"
#    parent: "Родители"
#    browser_recommendation: "За най-добър ефект поддържай последна версия на Chrome. Изтегли този браузер оттук!"
...
#    cancel: "Отказ"
  ...
  play:
#    title: "Играй CodeCombat нива - изучавай Python, JavaScript, и HTML"
